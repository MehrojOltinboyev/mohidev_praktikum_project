...
from .views import user_login, dashbord_view,user_register
from .views import custom_logout,SignUpView,edit_user, EditUserView
...
urlpatterns = [
    ...
    path('profile/',dashbord_view,name='user_profile'),
