...
def news_detail(request, news):
    ...
    #hits = hit_count.hits
    #hitcontext = context['hitscount'] = {'pk':hit_count.pk}
    ...
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            #yangi comment objectini yaratamiz lekin   DB ga saqlamaymiz
...
class NewsCreateView(OnlyLoggedSuperUser,CreateView):
    ...
    fields = ('title','slug','image','body','image','category','status')
